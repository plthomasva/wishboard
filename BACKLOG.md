...
- **[#335](https://github.com/plthomasva/wishboard/issues/335)** — Clean up legacy orphaned repository variables (`DOMAIN_NAME`, `DATABASE_URL`, `DATABASE_AUTH_TOKEN_SSM`, `AWS_STACK_NAME`) following matrix workflow migration.
