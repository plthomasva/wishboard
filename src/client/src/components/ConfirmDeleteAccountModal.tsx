...
export default function ConfirmDeleteAccountModal({ deletePreview, deleteError, onCancel, onConfirm }: Readonly<ConfirmDeleteAccountModalProps>) {
  return (
    <div className="kiosk-modal-backdrop" style={{ zIndex: 100000 }}>
      <div className="kiosk-modal" style={{ maxWidth: '500px' }}>
        ...
        <p>If you proceed, the following data will be permanently deleted along with the account:</p>
        ...
        <div className="kiosk-modal-actions" style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end', marginTop: '24px' }}>
          ...
          <button className="button" style={{ background: '#e53e3e', color: 'white', borderColor: '#e53e3e' }} onClick={onConfirm}>
            Yes, Delete Account
          </button>
        </div>
      </div>
